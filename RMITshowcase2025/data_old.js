...
var testList = [
  {
    ...
    key_projects: [
      ...
      },
      {
        ...
        project_cover_image: "s4021256/projects/project3.webp",
        youtube_link:
          "https://www.youtube.com/embed/avoY90IKX7I?si=U_BqG70pw39fBcoO",
      },
    ],
  },
  {
    ...
    key_projects: [
      ...
      },
      {
        ...
        project_cover_image: "s1234567/projects/project2.jpg",
        youtube_link:
          "https://www.youtube.com/embed/amTsBProNo4?si=X8NgW_cXcQG99n2g",
      },
      {
        title: "Long title of jazz piano 3",
        project_type: "sound",
        project_cover_image: "s1234567/projects/project3.jpg",
        youtube_link:
          "https://www.youtube.com/embed/NCKmnppmkfg?si=IB5eTHLsKKz2hN1Z",
      },
    ],
  },
];
console.log(testList[0].full_name);

// Moving foward: COMPILE AND PARSE JSON INTO A JS List, console log the
// parsed list, copy object from console, then use that JS obj for compiling
